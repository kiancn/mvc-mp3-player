...
public class GET
{
    private static IPresent presenter;
...
//                timesUserPressedEnter++;
    ...
    public static void setPresenter(IPresent presenter)
    {
        GET.presenter = presenter;
        setStream(presenter.getStream());
    }

    public static void setStream(PrintStream printStream)
    {
        GET.stream = printStream;
    }
}
